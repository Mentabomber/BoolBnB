    ...
    <div id="app">
        ...
        <header class="header">
            <div class="container-fluid" style="background-color: white; color:black;">
                <div class="row d-flex align-items-center justify-content-everly" style="line-height: 50px">
                    <div class="col-5" id="title">
                        <h2>BoolBnB</h2>
                    </div>
                    <a class="col-3 text-center navbar-header"
                ...
                <div class="row text-center d-flex justify-content-between text-center" id="name">
                    <div class="col-2">
                        ...
                        <div class="profile-links">
                            <div><a href="https://www.linkedin.com/in/alessandro-belfiore-695a5328a/">LinkedIn <i
                                        style="margin-left:10px;" class="fa-brands fa-linkedin"></i> </a></div>
                            <div><a href="https://github.com/Alecpu92">GitHub <i style="margin-left:10px;"
                    ...
                    <div class="col-2">
                        ...
                        <div class="profile-links">
                            <div><a href="https://www.linkedin.com/in/daniele-corrado-7217b628a/">LinkedIn <i
                                        style="margin-left:10px;" class="fa-brands fa-linkedin"></i> </a></div>
                            <div><a href="https://github.com/DanieleCorrado">GitHub <i style="margin-left:10px;"
                                        class="fa-brands fa-github"></i></a></div>
                        </div>
                    </div>
                    <div class="col-3">
                        ...
                        <div class="profile-links">
                            <div><a href="https://www.linkedin.com/in/fabio-di-giacomo-pepe">LinkedIn <i
                                        style="margin-left:10px;" class="fa-brands fa-linkedin"></i> </a></div>
                            <div><a href="https://github.com/fabiodigiacomopepe">GitHub <i style="margin-left:10px;"
                                        class="fa-brands fa-github"></i></a></div>
                        </div>
                    </div>
                    <div class="col-2">
                        ...
                        <div class="profile-links">
                            <div><a href="https://www.linkedin.com/in/tilen-simcic-043419265/">LinkedIn <i
                                        style="margin-left:10px;" class="fa-brands fa-linkedin"></i> </a></div>
                            <div><a href="https://github.com/Mentabomber">GitHub <i style="margin-left:10px;"
                                        class="fa-brands fa-github"></i></a></div>
                        </div>
                    </div>
                    <div class="col-2">
                        ...
                        <div class="profile-links">
                            <div><a href="https://www.linkedin.com/in/antonino-troia-140884207">LinkedIn <i
                                        style="margin-left:10px;" class="fa-brands fa-linkedin"></i> </a></div>
                            <div><a href="https://github.com/Ninotro">GitHub <i style="margin-left:10px;"
                                        class="fa-brands fa-github"></i></a></div>
                        </div>
                    </div>
                </div>
