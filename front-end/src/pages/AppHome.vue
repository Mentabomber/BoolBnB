    ...
    <div class="container">
        <h2>Case in <span class="color-green">Evidenza</span></h2>
            ...
            <div class="container">
                ...
                <div v-for="(apartment, index) in apartments" :key="index" :class="(this.AppFiltered.includes(apartment.id)) ? 'hidden' : 'col-md-4 col-sg-12' ">
...
<style scoped lang="scss">
    ...
    h2 {
        ...
        top: 0;
        right: 0;
        background-color: #15ba8f; /* Aggiungi un background color al tuo elemento <i> se necessario */
        padding: 5px; /* Aggiungi un padding al tuo elemento <i> per spaziatura */
        color: white; /* Imposta il colore del testo all'interno di <i> */
        font-size: 20px; /* Imposta la dimensione del testo all'interno di <i> */
